...
Feature: The level 1a: Basic Dying and Scoring
  ...
  row40: roll 2 skulls, 4 parrots, 2 swords, hold parrots, re-roll swords, get 1 skull 1 sword  die
    ...
    Then interface reports death & end of turn
    Examples:
      | row | card    | dieRoll                                                      | menuChoices | holdDice   | riggedReRoll          |
      | 39  | "Gold " | "skull, parrot, parrot, parrot, parrot, sword, sword, sword" | 2           | "2,3,4,5 " | "skull, skull, sword" |
      | 40  | "Gold " | "skull, skull, parrot, parrot, parrot, parrot, sword, sword" | 2           | "3,4,5,6 " | "skull, sword"        |
  ...
  row42: roll 1 skull, 4 parrots, 3 swords, hold parrots, re-roll swords, get 1 skull 2 monkeys re-roll 2 monkeys, get 1 skull 1 monkey and die
    ...
    Examples:"2 " + "2,3,4,5 " + "skull,monkey,monkey " + "2 " + "2,3,4,5 " + "skull,monkey ";
      | row | card    | dieRoll                                                      | menuChoices1 | holdDice1  | riggedReRoll1           | menuChoices2 | holdDice2  | riggedReRoll2   |
      | 42  | "Gold " | "skull, parrot, parrot, parrot, parrot, sword, sword, sword" | 2            | "2,3,4,5 " | "skull, monkey, monkey" | 2            | "2,3,4,5 " | "skull, monkey" |
  ...
  row63: score a set of 4 monkeys and a set of 3 coins (including the COIN fortune card) (SC 600)
    ...
    Examples:
      ...
      | 43  | "Captain " | "monkey, monkey, parrot, diamond, diamond, coin, coin, parrot"    | 800           |
      | 45  | "Gold "    | "monkey, monkey, monkey, sword, sword, sword, parrot, parrot"     | 300           |
      | 47  | "Gold "    | "diamond, diamond, diamond, monkey, monkey, parrot, sword, sword" | 500           |
      | 48  | "Diamond " | "coin, coin, coin, coin, monkey, parrot, sword, sword"            | 700           |
      | 49  | "Gold "    | "sword, sword, sword, parrot, parrot, parrot, parrot, monkey"     | 400           |
      | 53  | "Gold "    | "monkey, monkey, monkey, monkey, monkey, monkey, skull, parrot"   | 1100          |
      | 54  | "Gold "    | "parrot, parrot, parrot, parrot, parrot, parrot, parrot, monkey"  | 2100          |
      | 55  | "Gold "    | "coin, coin, coin, coin, coin, coin, coin, coin"                  | 5400          |
      | 56  | "Diamond " | "coin, coin, coin, coin, coin, coin, coin, coin"                  | 5400          |
      | 57  | "Captain " | "sword, sword, sword, sword, sword, sword, sword, sword"          | 9000          |
      | 63  | "Gold "    | "coin, coin, monkey, monkey, monkey, skull, skull, monkey"        | 600           |
  ...
  row62: score a set of 3 coins over 2 rolls  with FC is diamond (SC 500)
    ...
    Then player chooses to score board with expected score <ExpectedScore>
    Examples:
      | row | card       | dieRoll                                                          | menuChoices | holdDice   | riggedReRoll                          | ExpectedScore |
      | 44  | "Gold "    | "monkey, monkey, parrot, parrot, sword, sword, parrot, skull"    | 2           | "1,2 "     | "monkey, parrot, sword, sword, skull" | 200           |
      | 46  | "Gold "    | "monkey, monkey, parrot, parrot, sword, sword, skull, skull"     | 2           | "1,2,3,4 " | "monkey, parrot"                      | 300           |
      | 59  | "Diamond " | "diamond, parrot, parrot, monkey, monkey, skull, skull, parrot"  | 2           | "1,2,3 "   | "diamond, sword, sword"               | 400           |
      | 60  | "Gold "    | "diamond, diamond, parrot, monkey, monkey, skull, skull, parrot" | 2           | "1,2 "     | "diamond, monkey, monkey, parrot"     | 500           |
      | 61  | "Gold "    | "coin, coin, parrot, monkey, monkey, skull, skull, parrot"       | 2           | "1,2 "     | "coin, monkey, monkey, parrot"        | 600           |
      | 62  | "Diamond " | "coin, coin, parrot, monkey, monkey, skull, skull, parrot"       | 2           | "1,2 "     | "coin, monkey, monkey, parrot"        | 500           |
  ...
  row58: score set of 8 monkeys over several rolls (SC 4600 because of FC is coin and full chest)
    ...
    Then player chooses to score board with expected score <ExpectedScore>
    Examples:
      | row | card       | dieRoll                                                        | menuChoices1 | holdDice1      | riggedReRoll1                   | menuChoices2 | holdDice2      | riggedReRoll2           | ExpectedScore |
      | 50  | "Gold "    | "coin, coin, sword, sword, parrot, parrot, monkey, monkey"     | 2            | "1,2,3,4 "     | "sword, parrot, monkey, monkey" | 2            | "1,2,3,4,5 "   | "sword, parrot, coin"   | 800           |
      | 51  | "Captain " | "coin, coin, sword, sword, parrot, parrot, monkey, monkey"     | 2            | "1,2,3,4 "     | "sword, parrot, monkey, monkey" | 2            | "1,2,3,4,5 "   | "sword, parrot, coin"   | 1200          |
      | 52  | "Gold "    | "sword, sword, sword, parrot, monkey, parrot, skull, monkey"   | 2            | "1,2,3 "       | "sword, monkey, parrot, monkey" | 2            | "1,2,3,4 "     | "sword, parrot, monkey" | 600           |
      | 58  | "Gold "    | "monkey, monkey, parrot, monkey, monkey, sword, sword, parrot" | 2            | "1,2,3,4,5,6 " | "monkey, monkey"                | 2            | "1,2,4,5,7,8 " | "monkey, monkey"        | 4600          |
  ...
  Scenario Outline: get 7 swords on first roll, try to roll the 8 die by itself -> interface reports not allowed
    ...
    Examples:
      | row | card    | dieRoll                                                   |
      | 65  | "Gold " | "sword, sword, sword, sword, sword, sword, sword, monkey" |